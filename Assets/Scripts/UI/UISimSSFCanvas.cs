...
namespace UI
{
    public class UISimSSFCanvas : UIBase
    {
        ...
        private void Init()
        {
            ...
            paramControllers[6].SetParamValueWithoutCallback(ParticleControllerParams.Instance.restDensityRho);
            paramControllers[7].SetParamValueWithoutCallback(ParticleControllerParams.Instance.gasConstantB);
            paramControllers[8].SetParamValueWithoutCallback(ParticleControllerParams.Instance.viscosityMu);
        }
